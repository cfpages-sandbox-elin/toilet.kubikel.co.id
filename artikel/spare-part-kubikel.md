---
article_id: TKB-15-05
title: "Spare Part Hardware dan Material Cadangan"
slug: "spare-part-kubikel"
...
date_modified: null
parent_topic: TKB-15
primary_intent: "Menyiapkan komponen service"
reader_community: "Kubikel.co.id"
reader_address: "Teman Kubikel.co.id"
final_route: "/artikel/spare-part-kubikel.html"
...
# Spare Part Hardware dan Material Cadangan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Spare Part Hardware dan Material Cadangan”
...
- **Primary intent:** Menyiapkan komponen service
...
- **Scope boundary:** Bukan daftar SKU aktual.
- **Final public route:** `/artikel/spare-part-kubikel.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Spare Part Hardware dan Material Cadangan**.
...
- `TKB-15-04` → `/artikel/pengiriman-penerimaan-panel-kubikel.html` — Kemasan, Pengiriman, dan Penerimaan Panel
...
- **Tie back to this article:** Keep the explanation specific to “Spare Part Hardware dan Material Cadangan”.
