---
article_id: TKB-05-04
title: "Mockup Kubikel Toilet: Kapan Diperlukan?"
slug: "mockup-kubikel-toilet"
...
date_modified: null
parent_topic: TKB-05
primary_intent: "Menentukan kebutuhan prototype"
reader_community: "Kubikel.co.id"
reader_address: "Kawan Kubikel.co.id"
final_route: "/artikel/mockup-kubikel-toilet.html"
...
# Mockup Kubikel Toilet: Kapan Diperlukan?

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Mockup Kubikel Toilet: Kapan Diperlukan?”
...
- **Primary intent:** Menentukan kebutuhan prototype
...
- **Scope boundary:** Keputusan mockup; bukan produksi massal.
- **Final public route:** `/artikel/mockup-kubikel-toilet.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mockup Kubikel Toilet: Kapan Diperlukan?**.
...
- `TKB-05-03` → `/artikel/menilai-sampel-warna-kubikel.html` — Menilai Sampel Warna di Pencahayaan Toilet
- `TKB-05-05` → `/artikel/design-freeze-kubikel.html` — Design Freeze sebelum Produksi Kubikel
- `TKB-05-06` → `/artikel/change-control-kubikel.html` — Change Control untuk Warna, Material, dan Hardware
...
- **Tie back to this article:** Keep the explanation specific to “Mockup Kubikel Toilet: Kapan Diperlukan?”.
