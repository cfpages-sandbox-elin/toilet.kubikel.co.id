---
article_id: TKB-13-04
title: "Koordinasi Drilling dan Fixing saat Instalasi"
slug: "drilling-fixing-kubikel"
...
date_modified: null
parent_topic: TKB-13
primary_intent: "Mengurangi konflik dan kerusakan substrate"
reader_community: "Kubikel.co.id"
reader_address: "Teman Kubikel.co.id"
final_route: "/artikel/drilling-fixing-kubikel.html"
...
# Koordinasi Drilling dan Fixing saat Instalasi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Koordinasi Drilling dan Fixing saat Instalasi”
...
- **Primary intent:** Mengurangi konflik dan kerusakan substrate
...
- **Final public route:** `/artikel/drilling-fixing-kubikel.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Koordinasi Drilling dan Fixing saat Instalasi**.
...
- `TKB-13-03` → `/artikel/toleransi-pemasangan-kubikel.html` — Alignment, Gap, dan Toleransi Pemasangan
- `TKB-13-05` → `/artikel/uji-operasi-hardware-kubikel.html` — Uji Operasi Pintu dan Hardware Kubikel
- `TKB-13-06` → `/artikel/punch-list-kubikel-toilet.html` — Punch List dan Serah Terima Kubikel
...
- **Tie back to this article:** Keep the explanation specific to “Koordinasi Drilling dan Fixing saat Instalasi”.
