			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Toilet.Kubikel.co.id | Toilet Kubikel Indonesia Kualitas #1</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Toilet.Kubikel.co.id | Toilet Kubikel Indonesia Kualitas #1</title>
					</xsl:otherwise>
				</xsl:choose>
